      ...
      links: [
        {
          ...
          items: [
            ...
            {
              label: 'GitHub',
              href: 'https://github.com/productsway/docusaurus',
            },
          ],
        },
      ],
    ...
    [
      '@docusaurus/preset-classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/productsway/docusaurus/edit/master/website/',
        },
        blog: {
          showReadingTime: true,
          // Please change this to your repo.
          editUrl:
            'https://github.com/productsway/docusaurus/edit/master/website/blog/',
        },
        theme: {
